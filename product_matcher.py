...
PROBLEMS = {'gal.пастила h.s.p.мед.обл.': ['салатила', 'салат пастила', 'пастила н.', 's.p.мед', 's.p.нед', 'н.5.р.нец', 'h.s.p.мед'],
    ...
    'argeta паштет куриный 95г ж/б (дрога колинска' : ['argeta паштет куриный', 'argeta', 'argeta паштет', 'argeta паштет куриный 95г'],
    'яйцо столовое с1 10шт бокс' : ['яйцо столовое с1', 'столовое с1 10шт', 'с1 10шт бокс', 'яйцо столовое с1 10шт', 'яйцо столбное с1']}
